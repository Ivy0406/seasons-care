...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay
    ...
    className={cn(
      'data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 fixed inset-0 z-130 bg-black/25',
      className,
    )}
    {...props}
  />
