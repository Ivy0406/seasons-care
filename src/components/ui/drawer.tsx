...
import cn from "@/lib/utils"
>>>>>>> 336966e978d81179bde9ba0138760d43433f8efa
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay
    ...
    className={cn(
      'data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 fixed inset-0 z-50 bg-black/25',
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal data-slot="drawer-portal">
    ...
    <DrawerPrimitive.Content
      ...
      {...props}
    >
      <div className="mx-auto mt-2 hidden h-1 w-10 shrink-0 rounded-full bg-neutral-700 group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
));
